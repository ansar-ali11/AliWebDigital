          ...
          <div className="lg:col-span-4">
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-3 text-white/70">
                ...
                <a href="mailto:hello@aliwebdigital.com" className="hover:text-white transition-colors">hello@aliwebdigital.com</a>
              </li>
              <li className="flex items-start gap-3 text-white/70">
                <Phone size={16} className="mt-0.5 text-electric" />
                <a href="tel:+923000000000" className="hover:text-white transition-colors">+92 300 000 0000</a>
              </li>
              <li className="flex items-start gap-3 text-white/70">
