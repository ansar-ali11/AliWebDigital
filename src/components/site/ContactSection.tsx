        ...
        <div className="lg:col-span-5">
          ...
          <ul className="space-y-5 text-sm">
            <li className="flex items-center gap-4 text-white/80">
              <span className="size-10 grid place-items-center border border-white/15 text-electric"><Mail size={15} /></span>
              <a href="mailto:hello@aliwebdigital.com" className="hover:text-white">hello@aliwebdigital.com</a>
            </li>
            <li className="flex items-center gap-4 text-white/80">
              <span className="size-10 grid place-items-center border border-white/15 text-electric"><Phone size={15} /></span>
              <a href="tel:+923000000000" className="hover:text-white">+92 300 000 0000</a>
            </li>
            <li className="flex items-center gap-4 text-white/80">
              <span className="size-10 grid place-items-center border border-white/15 text-electric"><MapPin size={15} /></span>
